...
public final class PromptTemplates {
    ...
    public static final String SELL_DRAFT_SYSTEM =
            ...
            {"title":"string","description":"string","suggestedPrice":number,"suggestedCategory":"FOOD|TOY|DAILY|CLOTHING|ETC"}
            """;
    ...
    public static String sellDraftUser(List<String> keywords) {
        ...
        return """
                ...
                suggestedPrice는 이미지에서 추정 가능한 보수적인 중고 가격(원)이며 모르면 0으로 한다.
    ...
    public static final String LOW_CARBON_SUMMARY_SYSTEM =
            "너는 친환경 상품 설명 전문가다. 요청한 형식 그대로만 답한다.";
